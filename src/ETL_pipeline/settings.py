...
def get_root_dir(default_value: str = ".") -> Path:
    ...
    return Path(os.getenv("GUIDE_HELPER_ROOT_DIR", default_value))


ETL_ROOT_DIR = Path(os.path.abspath(get_root_dir()))
DATA_DIR = ETL_ROOT_DIR / "data"
DATA_DIR.mkdir(parents=True, exist_ok=True)

SETTINGS = load_env_vars(root_dir=ETL_ROOT_DIR)
