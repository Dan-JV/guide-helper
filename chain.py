...
# embeddings_model = BedrockEmbedding(model="amazon.titan-embed-text-v1")
# embeddings_model = HuggingFaceEmbeddings(model_name="BAAI/bge-m3")
embeddings_model = BedrockEmbeddings(client=boto_client, model_id="amazon.titan-embed-text-v1") 
